<template>
	<div class="diy_details_box diy_div_postgraduate_examination_materials">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/data_sharing/edit','add')" @click="to_form('/data_sharing/edit')" > 分享 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/postgraduate_examination_materials/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/postgraduate_examination_materials/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var postgraduate_examination_materials_id = this.obj.postgraduate_examination_materials_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "postgraduate_examination_materials",
          source_field: "postgraduate_examination_materials_id",
          source_id: postgraduate_examination_materials_id
        }, (res) => {
