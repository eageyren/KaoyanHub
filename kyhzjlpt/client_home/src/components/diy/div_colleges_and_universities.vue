<template>
	<div class="diy_details_box diy_div_colleges_and_universities">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/colleges_and_universities/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/colleges_and_universities/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var colleges_and_universities_id = this.obj.colleges_and_universities_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "colleges_and_universities",
          source_field: "colleges_and_universities_id",
          source_id: colleges_and_universities_id
        }, (res) => {
