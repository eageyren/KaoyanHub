<template>
	<div class="diy_details page_postgraduate_examination_materials" id="postgraduate_examination_materials_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_postgraduate_examination_materials'>
							<div_postgraduate_examination_materials :obj="obj"></div_postgraduate_examination_materials>
...
<script>
	import div_postgraduate_examination_materials from "@/components/diy/div_postgraduate_examination_materials.vue";
	...
	export default {
		...
		components:{
			...
			bar_title,
			form_editor,
			div_postgraduate_examination_materials
		},
		data(){
			return{
				...
				form_comment: {
					...
					source_field: "postgraduate_examination_materials_id",
					source_id: 0,
					reply_to_id: 0,
				},
				count_pages: 1, // 页面数
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/postgraduate_examination_materials/set?postgraduate_examination_materials_id=' + obj["postgraduate_examination_materials_id"], {
					hits
				}, (res) => {
					if(res.result){
						...
						var body = {
							source_table: "postgraduate_examination_materials",
							source_field: "postgraduate_examination_materials_id",
							source_id: this.obj.postgraduate_examination_materials_id,
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.postgraduate_examination_materials_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "postgraduate_examination_materials",
					source_field: "postgraduate_examination_materials_id",
					source_id: obj["postgraduate_examination_materials_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/postgraduate_examination_materials/set?postgraduate_examination_materials_id=' + _this.obj["postgraduate_examination_materials_id"], {
								praise_len
							}, (res) => {
								if(res.result){
