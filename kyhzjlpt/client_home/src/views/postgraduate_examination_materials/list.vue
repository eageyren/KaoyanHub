<template>
	<div class="diy_list page_postgraduate_examination_materials" id="postgraduate_examination_materials_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">考研资料列表</span>
					</div>
				</div>
						...
						<div class="view">
							<span class="diy_list_search_title">关键字搜索：</span>
								<b-form-input size="sm" class="mr-sm-2" placeholder="资料名称搜索" v-model="query['data_name']" />
									...
									<b-form-input size="sm" class="mr-sm-2" placeholder="知识点搜索" v-model="query['knowledge_points']" />
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_postgraduate_examination_materials :list="list" />
						<!-- /列表 -->
					</div>
				</div>
				...
				list_sort: [{
					...
					},
					{
						...
						value: "data_type desc",
							...
							{
						name: "知识点正序",
						value: "knowledge_points asc",
					},
					{
						name: "知识点倒序",
						value: "knowledge_points desc",
					},
						],
